...
public class InvoiceDatalActivity extends AppCompatActivity {
    private ActivityInvoiceDatalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInvoiceDatalBinding.inflate(getLayoutInflater());
